...
export default function StepHubDocuments({ hubId, onComplete, onBack }) {
  ...
  const canContinue = Boolean(hubId && requiredUploaded && facialIdentity);
  ...
  const handleComplete = () => {
    ...
    toast.success("Verification submitted. Payment checkout is temporarily bypassed.");
    onComplete();
  };
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
        <p className="font-medium mb-1">Payment checkout is temporarily bypassed.</p>
        <p>
          After document upload and liveness verification, your hub registration
          will continue directly to the dashboard.
        </p>
      </div>
