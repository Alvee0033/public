...
export default function TutorTagForm({ setFieldValue, values, errors, touched, onSave, isSubmitting }) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <Input
                        ...
                        className={`w-full ${errors?.years_of_experience && touched?.years_of_experience ? "border-red-500" : ""}`}
                    />
                    {errors?.years_of_experience && touched?.years_of_experience && (
                        <div className="text-red-500 text-sm mt-1">{errors.years_of_experience}</div>
                    )}
                </div>
                ...
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) => handleInputChange('rating_score', parseFloat(e.target.value) || 0)}
