        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-30px">
          <div className="lg:col-start-1 lg:col-span-8 space-y-[35px]">
            ...
            <div>
              ...
              {/* blog content */}
              <div>
                <p className="text-lg text-darkdeep4 mb-25px !leading-30px">
                ...
                <p className="text-lg text-darkdeep4 mb-30px !leading-30px">
                  We have covered many special events such as fireworks, fairs,
                  parades, races, walks, awards ceremonies, fashion shows,
                  sporting events, and even a memorial service.
                </p>
                <p className="text-lg text-darkdeep4 mb-35px !leading-30px">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Curabitur vulputate vestibulum Phasellus rhoncus, dolor eget
                  viverra pretium, dolor tellus aliquet nunc, vitae ultricies
                  erat elit eu lacus. Vestibulum non justo consectetur, cursus
                ...
                <div className="pt-55px pr-10 pb-60px pl-70px xs:p-5 sm:pt-55px sm:pr-10 sm:pb-60px sm:pl-70px mb-43px bg-blackColor2  text-whiteColor -dark font-medium relative">
                  ...
                  <Link
                    href="#"
                    className="text-size-17 leading-23px relative pl-60px before:w-45px before:h-0.5 before:bg-whiteColor  before:absolute before:left-0 before:top-2/4"
                  >
                    John Mirnsdo
                  </Link>
                  <div className="absolute left-[22%] top-[22%] md:left-[37%] md:top-[14%]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-30px mb-50px">
                  {/* about left */}
                  <div className="md:col-start-1 md:col-span-4 relative">
                    <div>
                  ...
                  <div className="md:col-start-5 md:col-span-8">
                    <h4 className="text-2xl font-bold text-blackColor  mb-15px !leading-30px">
                      Why search Is Important ?
                    </h4>
                    <ul className="space-y-3">
                      <li className="flex items-center group">
                        <i className="icofont-check px-0.5 py-2 text-primaryColor bg-whitegrey3 bg-opacity-40 group-hover:bg-primaryColor group-hover:text-white group-hover:opacity-100 mr-15px "></i>
