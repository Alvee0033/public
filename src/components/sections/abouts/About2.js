    ...
    <section>
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-30px pt-20">
          ...
          <div>
            <div>
              <div className=" relative">
                <Image className="w-full" src={aboutImage8} alt="" />
                <Image
          ...
          {/* about right */}
          <div className="pl-0 lg:pl-35px">
            <SectionName>About Us</SectionName>
            <h3 className="text-3xl md:text-size-45 leading-10 md:leading-2xl font-bold text-blackColor  pb-25px">
              Welcome to the{" "}
            ...
            <p className="text-sm md:text-base leading-7 text-contentColor  mb-6">
