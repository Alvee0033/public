  ...
  return (
    <section>
      <div className="container pt-100px pb-100px">
        <h3 className="text-size-32 font-bold text-blackColor  leading-1.2 pb-15px border-b border-borderColor  mb-10">
          Apply As Instructor
        </h3>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-30px">
          {/* apply left */}
          <div>
            <h6 className="text-2xl font-semibold text-blackColor  leading-1.8 mb-15px">
              Become an Instructor
            </h6>
            <p className="text-contentColor  leading-1.8 mb-15px mt-5">
            ...
            <ul className="mb-30px space">
              <li className="mt-5 flex items-center gap-5">
                ...
                <p className="text-contentColor  leading-1.8">
          ...
          {/* apply righ */}
          <div>
            <form className="p-10px md:p-10 lg:p-5 2xl:p-10 mb-50px bg-darkdeep1  text-sm text-blackColor  leading-1.8">
              ...
              <div>
                <input type="checkbox" />{" "}
                <span className="text-size-15 text-contentColor ">
                  You agree to our friendly
                  <Link
                    href="#"
                    className="text-base text-blackColor  hover:text-primaryColor  font-bold leading-1 relative before:w-full before:h-1px before:bg-blackColor  before:absolute before:left-0 before:-bottom-0.5"
                  >
                    Privacy policy
                  </Link>
                  .
