                ...
                idx === 0 && (
                  ...
                  >
                    ...
                    <div className="p-5 md:p-35px md:pt-10">
                      <h3 className="text-2xl md:text-4xl leading-30px md:leading-45px font-bold text-blackColor hover:text-primaryColor pb-25px">
                        <Link href={`blogs/${id}`}>{title}</Link>
                      </h3>
                      <p className="text-base text-contentColor mb-30px">
                        {desc}
                      </p>
                      <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-sm md:text-lg text-darkdeep5">
                            By:
                        ...
                        <div>
                          <ul className="flex gap-1">
                            <li>
                              <a
                                href="#"
                                className="text-sm md:text-size-15 w-5 h-5 md:w-[39px] md:h-[39px] flex items-center justify-center border border-borderColor text-darkdeep4 hover:text-primaryColor  rounded"
                              >
              ...
              {blogs?.length &&
                blogs.map(
                  ({ id, title, date, image, month }, idx) =>
                    idx > 0 &&
                    idx < 3 && (
                      <div key={idx} className="group shadow-blog">
                        {/*  blog thumbnail  */}
                        <div className="overflow-hidden relative">
                          <Image
                            src={images[idx]}
                        ...
                        <div className="px-5 py-25px">
                          <h3 className="text-2xl md:text-size-28 leading-30px md:leading-35px font-bold text-blackColor hover:text-primaryColor">
                            <Link href={`blogs/${id}`}>{title}</Link>
                          </h3>
                        </div>
                      </div>
