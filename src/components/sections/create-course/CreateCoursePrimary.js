          ...
          <div className="lg:col-start-1 lg:col-span-8">
            <ul className="accordion-container curriculum create-course">
              ...
              <li className="accordion mb-5 active">
                <div className="bg-whiteColor  shadow-accordion  rounded-t-md">
                  {/*  controller */}
                  <div className="py-5 px-30px">
                    <div className="cursor-pointer accordion-controller flex justify-between items-center text-lg text-headingColor font-semibold w-full  font-hind leading-27px rounded-t-md">
                      <div>
                  ...
                  <div className="accordion-content transition-all duration-500 overflow-hidden">
                    <div className="content-wrapper py-4 px-5">
                      <div>
                        <form className="p-10px md:p-10 lg:p-5 2xl:p-10 bg-darkdeep1  text-sm text-blackColor  leading-1.8">
                          <div className="grid grid-cols-1 mb-15px gap-15px">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full py-10px px-5 text-sm focus:outline-none text-contentColor  bg-whiteColor  border-2 border-borderColor  placeholder:text-placeholder placeholder:opacity-80 leading-23px rounded-md font-no"
                              />
                            </div>
                            <div>
                              <label className="mb-3 block font-semibold">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full py-10px px-5 text-sm focus:outline-none text-contentColor  bg-whiteColor  border-2 border-borderColor  placeholder:text-placeholder placeholder:opacity-80 leading-23px rounded-md"
                              />
                            </div>
                            <div>
                              <p className="flex items-center gap-0.5">
                          ...
                          <div className="mb-15px">
                            ...
                            <textarea
                              className="w-full py-10px px-5 text-sm text-contentColor  bg-whiteColor  border-2 border-borderColor  placeholder:text-placeholder placeholder:opacity-80 leading-23px rounded-md"
                              cols="30"
                              rows="10"
                            />
                          </div>
              ...
              <li className="accordion mb-5">
                <div className="bg-whiteColor  shadow-accordion ">
                  {/*  controller */}
                  <div className="py-5 px-30px">
                    <div className="cursor-pointer accordion-controller flex justify-between items-center text-lg text-headingColor font-semibold w-full  font-hind leading-27px">
                      <div>
                    ...
                    <div className="content-wrapper py-4 px-5">
                      <div>
                        <div className="mt-15px">
                          <a
                            href="#"
                            className="text-size-15 text-whiteColor bg-primaryColor px-25px py-10px border border-primaryColor hover:text-primaryColor hover:bg-whiteColor inline-block rounded group  "
                          >
                            Add New Topic
                          </a>
                        </div>
                          ...
                          <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-30px">
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full py-10px px-5 mb-15px text-sm text-contentColor  text-start bg-whiteColor  border-2 border-borderColor  placeholder:text-placeholder placeholder:opacity-80 leading-23px rounded-md"
                                cols="30"
                                rows="10"
                              />
                            ...
                            <div>
                              ...
                              <textarea
                                className="w-full py-10px px-5 mb-15px text-sm text-contentColor  bg-whiteColor  border-2 border-borderColor  placeholder:text-placeholder placeholder:opacity-80 leading-23px rounded-md"
                                defaultValue={"Add your course benefits here."}
                                cols="30"
                                rows="10"
                              />
              ...
              {/*  accordion */}
              <li className="accordion mb-5">
                <div className="bg-whiteColor  shadow-accordion  rounded-b-md">
                  {/*  controller */}
                  <div className="cursor-pointer py-5 px-30px">
                    <div className="accordion-controller flex justify-between items-center text-lg text-headingColor font-semibold w-full  font-hind leading-27px rounded-b-md">
                      <div>
            ...
            <div className="p-30px border-2 border-primaryColor">
              <ul>
                <li className="my-7px flex gap-10px">
                  ...
                  <p className="text-lg text-contentColor  leading-1.45">
