      ...
      <div className="container py-50px md:py-70px lg:py-20 2xl:py-100px">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-30px">
          <div className="lg:col-start-1 lg:col-span-8 space-y-[35px]">
            {/* event heading  */}
            <div>
              <p className="text-sm text-whiteColor bg-indigo rounded leading-25px px-2 mb-30px inline-block">
                Mechanical
              </p>
              <h3 className="text-3xl md:text-size-40 leading-11 md:leading-13.5 text-blackColor  mb-15px font-bold">
                Become a product manager learn the Skills & job.
              </h3>
              <div className="flex flex-wrap items-center">
                <div className="flex mr-26px md:mr-76px items-center">
                  <div className="flex-shrink-0 w-66px h-66px">
                    <Image src={eventImage5} alt="" />
                  </div>
                  <div>
                    <p className="text-base md:text-size-11 lg:text-base font-medium text-blackColor  leading-19px">
                      Teacher:
                    </p>
                    <p className="text-sm md:text-xs lg:text-sm text-contentColor  leading-4 mb-15px">
                      Elon Masksd
                    </p>
                  </div>
                </div>
                <div className="mr-26px md:mr-76px">
                  <div>
                    <p className="text-base md:text-size-11 lg:text-base font-medium text-blackColor  leading-19px">
                      Last Update:
                    </p>
            ...
            <div className="mt-35px mb-30px">
              ...
              <div className="overflow-hidden relative mb-35px">
                <Image src={eventImage6} alt="" className="w-full" />
              </div>
              {/* blog content  */}
              <div>
                <h4 className="text-size-26 font-bold text-blackColor  mb-15px !leading-30px">
                  Description
                </h4>
                <p className="text-darkdeep4 mb-15px !leading-29px">
                ...
                <ul>
                  <li>
                    <p className="text-contentColor  mb-10px !leading-29px">
          ...
          <div className="lg:col-start-9 lg:col-span-4">
            {/* enroll section  */}
            <div className="py-33px px-25px shadow-event mb-30px">
              <div className="flex justify-between mb-50px">
                ...
                <div>
                  <Link
                    href="#"
                    className="uppercase text-sm font-semibold text-secondaryColor2 leading-27px px-2 bg-whitegrey1 "
                  >
                    68% Scholarship
                  </Link>
                </div>
              ...
              <ul>
                <li className="flex items-center gap-x-10px mb-25px pb-22px border-b border-borderColor ">
                  <div>
                    <svg
                      width="18"
                      height="19"
                  ...
                  <div>
                    <p className="text-sm font-medium text-contentColor ">
                      <span className="mr-7px text-blackColor ">End:</span>
                ...
                <li className="flex items-center gap-x-10px mb-25px pb-22px border-b border-borderColor ">
                  ...
                  <div>
                    <p className="text-sm font-medium text-contentColor ">
                      <span className="mr-7px text-blackColor ">Time:</span>
                      10:45 AM-01:30 PM
                    </p>
                  </div>
                </li>
                <li className="flex items-center gap-x-10px mb-25px pb-22px border-b border-borderColor ">
                  ...
                  <div>
                    <p className="text-sm font-medium text-contentColor ">
                      <span className="mr-7px text-blackColor ">Venue:</span>
              ...
              <div className="mt-30px">
                <button
                  type="submit"
                  className="text-size-15 text-whiteColor bg-primaryColor px-14 py-10px border border-primaryColor hover:text-primaryColor hover:bg-whiteColor inline-block rounded group  "
                >
                  Enroll Now Course
                </button>
              </div>
            ...
            {/* sponsored section  */}
            <div className="py-33px px-25px shadow-event mb-30px">
              <h4 className="text-size-21 text-blackColor  font-bold leading-25px">
                Sopnsored
              </h4>
              <div className="mt-25px mb-30px">
                <Image src={eventDetails2} alt="" />
              </div>
              <p className="text-contentColor  font-semibold leading-19px mb-15px">
                Thomas R. Toe
              </p>
              <p className="text-sm text-contentColor  font-medium leading-[17px]">
                <span className="text-blackColor ">Email:</span>
              ...
              <div>
                <ul className="flex gap-10px items-center mt-5">
                  <li>
                    <p className="text-xl font-semibold text-contentColor  leading-6">
                      Share:
                    </p>
                  </li>
                  <li>
                    <Link
                      href="#"
                      className="w-10 h-9 leading-9 text-center text-skycolor bg-whitegrey2 hover:text-whiteColor hover:bg-primaryColor     rounded"
                    >
                  ...
                  <li>
                    <Link
                      href="#"
                      className="w-10 h-9 leading-9 text-center text-deepred bg-whitegrey2 hover:text-whiteColor hover:bg-primaryColor     rounded"
                    >
