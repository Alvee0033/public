      ...
      <div className="container-fluid-2 ">
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-30px">
          ...
          <div className="xl:col-start-5 xl:col-span-8 relative">
            <div>
              <h4 className="text-2xl sm:text-size-28 font-bold leading-1.2 text-blackColor ">
                Latest Assignment lists
              </h4>
              <hr className="border-borderColor2  my-4" />
              <div className="overflow-auto">
                <table className="w-full text-left text-nowrap">
                  ...
                  <tbody className="text-size-13 md:text-base text-contentColor  font-normal">
                    ...
                    <tr className="leading-1.8 md:leading-1.8 bg-lightGrey5 ">
                      <th className="px-5px py-10px md:px-5 font-normal">
                        <span className="text-blackColor  font-bold">
                          Write a the 5
                        </span>
            ...
            <div>
              <div>
                ...
                <form>
                  <div className="mb-4">
                    <label
                      className="text-darkBlue  mb-2 block"
                      htmlFor="email"
                    >
                      Email address
                    </label>
                  ...
                  <div className="mb-4">
                    <label className="text-darkBlue  mb-2 block" htmlFor="file">
                      Drop file here
                    </label>
                    <input
                      type="file"
