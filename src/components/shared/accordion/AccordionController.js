      ...
      {type === "primary" ? (
        <>
          ...
          <button className="accordion-controller px-3 py-4">
            <span className="w-[10px] h-[1px] bg-darkdeep11 block "></span>
            <span className="w-[10px] h-[1px] bg-darkdeep11 block  rotate-90 -mt-[1px] transition-all duration-500"></span>
          </button>
        </>
      ) : (
        <button
          className={`accordion-controller flex justify-between items-center text-headingColor font-bold w-full   text-start leading-[20px] ${
            type === "secondaryLg"
