...
const ClientComment = () => {
  return (
    <div className="pt-50px pb-15px border-y border-borderColor2 ">
      ...
      <ul>
        <li className="flex gap-30px mb-10">
          ...
          <div className="flex-grow">
            <div className="flex justify-between items-center">
              <div>
                <h4>
                  <Link
                    href="#"
                    className="text-lg font-semibold text-blackColor hover:text-primaryColor   leading-25px"
                  >
                    Rohan De Spond
                  </Link>
                </h4>
                <p className="text-xs font-medium text-contentColor  leading-29px uppercase mb-5px">
                  25 JANUARY 2024
                </p>
              </div>
              <div className="author__icon">
                <button className="group">
                  ...
                  >
                    <path
                      className="group-hover:fill-primaryColor   block"
            ...
            <p className="text-sm text-contentColor  leading-23px mb-15px">
