...
const Blog = ({ blog }) => {
  ...
  return (
    <div className="shadow-dropdown-secodary bg-transparent">
      <div className="relative group p-10px">
        ...
        <div className="absolute left-[30px] bottom-[30px]">
          <Link
            href={`/blogs/${id}`}
            className="px-12 py-10px text-size-15 leading-1 text-whiteColor bg-blackColor border border-blackColor hover:text-blackColor hover:bg-whiteColor rounded-full -dark    "
          >
            Story
          </Link>
        </div>
      ...
      <div className="pt-30px pr-5 pb-10 pl-30px md:py-5 md:px-10 lg:pt-30px lg:pr-10px lg:pb-10 lg:pl-5 2xl:pt-30px 2xl:pr-5 2xl:pb-10 2xl:pl-30px">
        ...
        <h5>
          <Link
            href={`/blogs/${id}`}
            className="text-2xl md:text-xl 2xl:text-2xl leading-8 md:leading-7 2xl:leading-8 font-bold text-blackColor  hover:text-primaryColor  mb-15px"
          >
            {title}
          </Link>
        </h5>
        <Link
          href={`/blogs/${id}`}
          className="text-blackColor hover:text-primaryColor"
        >
