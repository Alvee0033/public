...
const BlogPrimary = ({ blog, idx }) => {
  ...
  return (
    <div className="group shadow-blog2">
      {/* blog thumbnail  */}
      ...
      <div className="pt-26px pb-5 px-30px">
        <h3 className="text-2xl md:text-size-32 lg:text-size-28 2xl:text-size-34 leading-34px md:leading-10 2xl:leading-13.5 font-bold text-blackColor2 hover:text-primaryColor">
          <Link href={`/blogs/${id}`}>{title}</Link>
        </h3>
        <div className="mb-14px pb-19px border-b border-borderColor ">
          <ul className="flex flex-wrap items-center gap-x-15px">
            <li>
              <Link
                href={`/blogs/${id}`}
                className="text-contentColor text-sm hover:text-primaryColor"
              >
        ...
        <p className="text-base text-contentColor  mb-15px !leading-30px">
          {desc}
        </p>
        <div className="flex justify-between items-center">
          ...
          <div className="text-primaryColor hover:text-secondaryColor space-y-1">
            <Link href="#">
              <i className="icofont-share bg-whitegrey1  hover:text-whiteColor hover:bg-primaryColor w-8 h-7 leading-7 text-center inline-block rounded transition-all duration-300"></i>
            </Link>{" "}
            <Link href="#">
              <i className="icofont-heart bg-whitegrey1  hover:text-whiteColor hover:bg-primaryColor w-8 h-7 leading-7 text-center inline-block rounded transition-all duration-300"></i>
            </Link>
          </div>
        </div>
      </div>
