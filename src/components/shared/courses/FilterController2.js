const FilterController2 = () => {
  return (
    <div>
      <ul className="filter-controllers flex flex-wrap md:flex-nowrap justify-center bg-whiteColor  p-10px 3xl:px-10 py-0 2xl:mx-50px mb-25px rounded button-group filters-button-group">
        <li>
          <button
            data-filter="*"
