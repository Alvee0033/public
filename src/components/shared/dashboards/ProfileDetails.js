const ProfileDetails = () => {
  return (
    <div className="p-10px md:px-10 md:py-50px mb-30px bg-whiteColor  shadow-accordion  rounded-5">
      <div className="mb-6 pb-5 border-b-2 border-borderColor ">
        <h2 className="text-2xl font-bold text-blackColor ">My Profile</h2>
      </div>

      <div>
        <ul>
          <li className="text-lg text-contentColor  leading-1.67 grid grid-cols-1 md:grid-cols-12 gap-x-30px">
          ...
          <li className="text-lg text-contentColor  leading-1.67 grid grid-cols-1 md:grid-cols-12 gap-x-30px mt-15px">
            <div className="md:col-start-1 md:col-span-4">
