  ...
  return (
    <div>
      {!isHeading ? (
        ...
        <h4 className="text-2xl sm:text-size-28 font-bold leading-1.2 text-blackColor  mb-15px">
          Quiz Result
        </h4>
      )}
      <div className="overflow-auto">
        {!results?.length ? (
          ...
          <table className="w-full text-left text-nowrap">
            <thead className="text-sm md:text-base text-blackColor  bg-lightGrey5  leading-1.8 md:leading-1.8">
              <tr>
            ...
            <tbody className="text-size-13 md:text-base text-contentColor  font-normal">
              {results?.map(
                (
                  {
                    id,
                  ...
                  <tr
                    ...
                    className={`leading-1.8 md:leading-1.8 ${
                      idx % 2 === 0 ? "" : "bg-lightGrey5 "
                    }`}
                  >
                    <th className="px-5px py-10px md:px-5 font-normal">
                      {date ? <p>{date}</p> : ""}
                      <span className="text-blackColor  font-bold">
                        {title}
                      </span>
                      <p>
                        {courseName ? "course: " : "Student: "}{" "}
                        <a className="text-blackColor " href="#">
                    ...
                    <td className="px-5px py-10px md:px-5">
                      <div className="dashboard__button__group">
                        <a
                          className="flex items-center gap-1 text-sm font-bold text-whiteColor hover:text-primaryColor bg-primaryColor hover:bg-whiteColor  border border-primaryColor h-30px w-full px-14px leading-30px justify-center rounded-md my-5px"
                          href="#"
                        >
                          {" "}
                          {isView ? (
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 text-sm font-bold text-whiteColor hover:text-secondaryColor bg-secondaryColor hover:bg-whiteColor  border border-secondaryColor h-30px w-full px-14px leading-30px justify-center rounded-md my-5px"
                        >
                          {isSubmit ? (
                            <>
