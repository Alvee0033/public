    ...
    <ul className="accordion-container curriculum">
      ...
      <li className="accordion mb-25px overflow-hidden active">
        <div className="bg-whiteColor border border-borderColor   rounded-t-md">
          {/* controller  */}
          <div>
            <button className="accordion-controller flex justify-between items-center text-xl text-headingColor font-bold w-full px-5 py-18px  font-hind leading-[20px]">
              <span>Lesson #01</span>
          ...
          <div className="accordion-content transition-all duration-500">
            <div className="content-wrapper p-10px md:px-30px">
              <ul>
                <li className="py-4 flex items-center justify-between flex-wrap border-b border-borderColor ">
                  <div>
                    <h4 className="text-blackColor  leading-1 font-light">
                      <i className="icofont-video-alt mr-10px"></i>
                      <Link
                        href={`/lessons/1`}
                        className="font-medium text-contentColor  hover:text-primaryColor "
                      >
                        Course Intro
                      </Link>
                    </h4>
                  </div>
                  <div className="text-blackColor  text-sm flex items-center">
                ...
                <li className="py-4 flex items-center justify-between flex-wrap border-b border-borderColor gap-3">
                  <div>
                    <h4 className="text-blackColor leading-1 font-light">
                      <i className="icofont-video-alt mr-10px"></i>
                      <Link
      ...
      <li className="accordion mb-25px overflow-hidden">
        <div className="bg-whiteColor border border-borderColor  ">
          {/* controller  */}
          <div>
            <button className="accordion-controller flex justify-between items-center text-xl text-headingColor font-bold w-full px-5 py-18px  font-hind leading-[20px]">
              <span>Lesson #02</span>
      ...
      <li className="accordion mb-25px overflow-hidden">
        <div className="bg-whiteColor border border-borderColor   rounded-b-md">
          {/* controller  */}
          <div>
            <button className="accordion-controller flex justify-between items-center text-xl text-headingColor font-bold w-full px-5 py-18px  font-hind leading-[20px]">
              <span>Lesson #04</span>
