  ...
  return (
    <div className="container mx-auto px-8 py-8 ">
      <div className="flex justify-center text-center  pt-10 pb-10">
        <div>
          <h1 className="font-bold text-4xl text-primary">Subscribe Now!</h1>
        ...
        <Card className="w-full rounded-2xl overflow-hidden text-center  transition-all duration-300 hover:shadow-xl hover:scale-95">
          <Link href="">
            ...
            <CardContent className="mt-3 pb-2 px-5">
              <h3 className="text-4xl font-bold text-primary uppercase truncate">
                Bronge
              </h3>
              <div className="mt-4">
              ...
              <button className=" w-full text-2xl py-1 mt-4 mb-4 bg-brand rounded-md text-white font-semibold hover:scale-105 duration-200">
                Purchases
              </button>
            </CardContent>
          </Link>
